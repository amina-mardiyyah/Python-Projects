...
print('Hey there!. I am Annie')
name = input('What is your name?: ')
print('Hi!', name, ', Nice to meet you')

#1st conversation
feelings = input("How are you today?: ")
responses = ['Okay',"I'm fine","I'm doing great", "I'm ok","I'm good",'Good','Awesome', 'Great','Superb']
...
continent = input('What continent are you from?: ')
